...
//const InputWrapperBody =  InputWrappers[0].querySelector('._input-body');
//const InputWrapperButton =  InputWrappers[0].querySelector('.calculator-blok-search__button-icon');
//const InputWrapperBodyButton =  InputWrapperBody.querySelector('._button');
