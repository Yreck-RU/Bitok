...
for (let i = 0; i < selectSingle_labels.length; i++) {
  selectSingle_labels[i].addEventListener('click', (evt) => {
  	...
  	//alert(number);
    //selectSingle_title.value = number;
...
if (reset) {
	reset.addEventListener('click', () => {
		...
		alert(selectSingle_title.value);
		selectSingle_title.value = selectSingle_title.getAttribute('data-default');
	});
}
...
const selectSingle2_title = selectSingle2.querySelector('.__select2__title');
const selectSingle2_labels = selectSingle2.querySelectorAll('.__select2__label');
...
for (let i = 0; i < selectSingle2_labels.length; i++) {
  selectSingle2_labels[i].addEventListener('click', (evt) => {
  	...
  	//alert(number);
    //selectSingle_title.value = number;
    selectSingle2_title.value = evt.target.textContent;
    //selectSingle_title.textContent = evt.target.textContent;
    selectSingle2.setAttribute('data-state', '');
  });
}
...
if (reset2) {
	reset2.addEventListener('click', () => {
		//selectSingle_title.textContent = selectSingle_title.getAttribute('data-default');
		alert(selectSingle2_title.value);
		selectSingle2_title.value = selectSingle2_title.getAttribute('data-default');
	});
}
